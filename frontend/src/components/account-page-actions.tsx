...
export type AccountPageActionsProps = {
  canWrite: boolean
  onAddAccount: () => void
  onConnectBank?: () => void  // omitted in demo mode: no bank linking on a public demo
...
function DesktopSecondaryActions(props: AccountPageActionsProps) {
  ...
  return (
    <>
      ...
      {props.canWrite && props.onConnectBank && (
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        ...
        {props.canWrite && props.onConnectBank && <DropdownMenuItem onSelect={props.onConnectBank}><Plus size={16} />{t('accounts.connectBank')}</DropdownMenuItem>}
      </DropdownMenuContent>
    </DropdownMenu>
  )
}
